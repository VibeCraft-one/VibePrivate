...
- Protection service has SQLite-backed smoke coverage for HOME owner/member/guest access, op/bypass access, HOME/ADMIN environment flags, ADMIN overlap priority and cached-HOME versus later ADMIN overlap priority.
