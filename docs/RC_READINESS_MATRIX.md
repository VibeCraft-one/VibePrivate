...
| `.\gradlew.bat clean build --no-daemon` passes | `PROVEN` | Latest recorded full build passed on 2026-07-09 with 74/74 tests. | Re-run only after another code/resource change or immediately before tagging RC. |
