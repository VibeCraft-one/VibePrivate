...
public final class RegionStatusChangeEvent extends AbstractRegionEvent {
    ...
    public RegionStatusChangeEvent(String regionId, RegionType regionType, String ownerId,
